...
--
-- Dumping data for table `atividades_has_usuarios`
--

LOCK TABLES `atividades_has_usuarios` WRITE;
/*!40000 ALTER TABLE `atividades_has_usuarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `atividades_has_usuarios` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `permissoes` VALUES (4,'Cadastro de participantes'),(5,'Cadastro de eventos'),(6,'Emisṣo de certificados'),(7,'Cadastro de atividades');
...
CREATE TABLE `permissoesUsuarios` (
  ...
  PRIMARY KEY (`pusID`),
  KEY `fk_permissoesUsuarios_2_idx` (`pusUsuId`),
  KEY `fk_permissoesUsuarios_1_idx` (`pusPerId`),
  CONSTRAINT `fk_permissoesUsuarios_1` FOREIGN KEY (`pusPerId`) REFERENCES `permissoes` (`perId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_permissoesUsuarios_2` FOREIGN KEY (`pusUsuId`) REFERENCES `usuarios` (`usuId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pessoas` VALUES (126,'marcio','3456789','456789','2010-10-10','marciomjapr@gmail.com','456789');
...
INSERT INTO `usuarios` VALUES (84,'joao','1234',0,126,'f0935e4cd5920aa6c7c996a5ee53a70f',1,0);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'eventus'
--
...
-- Dump completed on 2017-06-06 10:31:40